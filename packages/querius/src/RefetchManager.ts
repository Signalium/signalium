import type { QueryInstance } from './QueryResult.js';
...
export class RefetchManager {
  ...
  private buckets = new Map<number, Set<QueryInstance<any>>>();
...
export class NoOpRefetchManager {
  addQuery(_instance: QueryInstance<any>): void {
    // No-op: do nothing
  }

  removeQuery(_query: QueryInstance<any>): void {
    // No-op: do nothing
  }
