  ...
  describe('discriminated union validation', () => {
    describe('entities without __typename', () => {
      ...
      it('should throw for missing typename in nested entity union', () => {
        ...
        const QueryResult = t.object({ owner: t.entity(Owner) });

        const result = {
          owner: {
            __typename: 'Owner',
            id: 1,
            pet: { id: 2, color: 'Orange' },
          },
        };
  ...
  describe('union type combinations', () => {
    ...
    describe('array of discriminated entities', () => {
      ...
      it('should parse array of entity union correctly', async () => {
        ...
        const dogDoc1 = await getDocument(kv, getEntityKey('Dog', 1, getShapeKey(t.entity(Dog))));
        expect((dogDoc1 as any).breed).toBe('Lab');

        const catDoc = await getDocument(kv, getEntityKey('Cat', 2, getShapeKey(t.entity(Cat))));
    ...
    describe('valid primitive + object/entity combinations', () => {
      ...
      it('should allow null/undefined with entities', () => {
        ...
        const unionType = t.union(t.entity(TestEntity), t.null);
      ...
      it('should parse nullable entity union in entity context', async () => {
        ...
        const QueryResult = t.object({ parent: t.entity(Parent) });
        ...
        const parentDoc = await getDocument(kv, getEntityKey('Parent', 1, getShapeKey(t.entity(Parent))));
  ...
  describe('Entity integration', () => {
    ...
    describe('entity unions', () => {
      ...
      it('should handle array of entity unions', async () => {
        ...
        const dogDoc = await getDocument(kv, getEntityKey('Dog', 1, getShapeKey(t.entity(Dog))));
    ...
    describe('nested entity refs', () => {
      it('should track refs for nested entities in union', async () => {
        ...
        const ParentUnion = t.union(t.entity(ParentA), t.entity(ParentB));
        ...
        const parentKey = getEntityKey('ParentA', 1, getShapeKey(t.entity(ParentA)));
        const childKey = getEntityKey('Child', 10, getShapeKey(t.entity(Child)));
