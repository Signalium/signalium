...
describe('t.nullish/optional/nullable API', () => {
  describe('t.nullish()', () => {
    describe('with primitives', () => {
      it('should add undefined and null to string type', () => {
        ...
        expect((result as any) & Mask.STRING).toBeTruthy();
        expect((result as any) & Mask.UNDEFINED).toBeTruthy();
        expect((result as any) & Mask.NULL).toBeTruthy();
        expect(typeToString(result as any)).toBe('undefined | null | string');
      });

      it('should add undefined and null to number type', () => {
        const result = t.nullish(t.number);
        expect(typeof result).toBe('number');
        expect((result as any) & Mask.NUMBER).toBeTruthy();
        expect((result as any) & Mask.UNDEFINED).toBeTruthy();
        expect((result as any) & Mask.NULL).toBeTruthy();
        expect(typeToString(result as any)).toBe('undefined | null | number');
      });

      it('should add undefined and null to boolean type', () => {
        const result = t.nullish(t.boolean);
        expect(typeof result).toBe('number');
        expect((result as any) & Mask.BOOLEAN).toBeTruthy();
        expect((result as any) & Mask.UNDEFINED).toBeTruthy();
        expect((result as any) & Mask.NULL).toBeTruthy();
        expect(typeToString(result as any)).toBe('undefined | null | boolean');
      });
    ...
    describe('with complex types', () => {
      it('should add undefined and null masks to arrays', () => {
      ...
      it('should add undefined and null masks to objects', () => {
      ...
      it('should add undefined and null masks to records', () => {
    ...
    describe('with constant/enum types', () => {
      it('should create union with undefined and null for const', () => {
        ...
        expect(typeToString(result as any)).toBe('"active" | undefined | null');
      });
      ...
      it('should create union with undefined and null for enum', () => {
        ...
        const str = typeToString(result as any);
  ...
  describe('t.optional()', () => {
    describe('with primitives', () => {
      it('should add undefined to string type', () => {
        ...
        expect((result as any) & Mask.STRING).toBeTruthy();
        expect((result as any) & Mask.UNDEFINED).toBeTruthy();
        expect((result as any) & Mask.NULL).toBeFalsy();
        expect(typeToString(result as any)).toBe('undefined | string');
      });
      ...
      it('should add undefined to number type', () => {
        ...
        expect((result as any) & Mask.UNDEFINED).toBeTruthy();
        expect((result as any) & Mask.NULL).toBeFalsy();
        expect(typeToString(result as any)).toBe('undefined | number');
      });
    ...
    describe('with complex types', () => {
      it('should add undefined mask to arrays', () => {
      ...
      it('should add undefined mask to objects', () => {
        const objectType = t.object({
    ...
    describe('with constant/enum types', () => {
      it('should create union with undefined for const', () => {
        ...
        expect(typeToString(result as any)).toBe('42 | undefined');
      });
  ...
  describe('t.nullable()', () => {
    describe('with primitives', () => {
      it('should add null to string type', () => {
        ...
        expect((result as any) & Mask.STRING).toBeTruthy();
        expect((result as any) & Mask.NULL).toBeTruthy();
        expect((result as any) & Mask.UNDEFINED).toBeFalsy();
        expect(typeToString(result as any)).toBe('null | string');
      });
      ...
      it('should add null to number type', () => {
        ...
        expect((result as any) & Mask.NULL).toBeTruthy();
        expect((result as any) & Mask.UNDEFINED).toBeFalsy();
        expect(typeToString(result as any)).toBe('null | number');
      });
    ...
    describe('with complex types', () => {
      it('should add null mask to arrays', () => {
      ...
      it('should add null mask to objects', () => {
        const objectType = t.object({
    ...
    describe('with constant/enum types', () => {
      it('should create union with null for const', () => {
        ...
        expect(typeToString(result as any)).toBe('true | null');
      });
  ...
  describe('Combining methods', () => {
    it('should handle chaining with primitives', () => {
      ...
      expect((nullish as any) & Mask.STRING).toBeTruthy();
      expect((nullish as any) & Mask.UNDEFINED).toBeTruthy();
      expect((nullish as any) & Mask.NULL).toBeTruthy();
    });
