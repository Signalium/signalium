  ...
  describe('Entity integration', () => {
    ...
    describe('within object', () => {
      it('should parse number in nested object within entity', async () => {
        ...
        const QueryResult = t.object({ product: t.entity(Product) });
    ...
    describe('within array', () => {
      it('should parse number array in entity', async () => {
        ...
        const QueryResult = t.object({ stats: t.entity(Stats) });
        ...
        const key = getEntityKey('Stats', 1, getShapeKey(t.entity(Stats)));
        const doc = await getDocument(kv, key);
    ...
    describe('within record', () => {
      it('should parse number record in entity', async () => {
        ...
        const QueryResult = t.object({ metrics: t.entity(Metrics) });
        ...
        const key = getEntityKey('Metrics', 1, getShapeKey(t.entity(Metrics)));
        const doc = await getDocument(kv, key);
