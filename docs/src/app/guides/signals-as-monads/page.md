...
This article is a deep dive into the theory behind Signals and Signalium. If you're trying to jump into Signalium feet first and build something, you should instead [read the core docs first](/reactivity/reactive-functions) and come back to this when you have time later.
{% /callout %}
